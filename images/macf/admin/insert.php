...
if(isset($_POST['sub']))
{
    ...
    $sql=mysqli_query($con,"INSERT INTO `products`(`title`, `prize`, `brandname`, `images`, `descriptions`,`size`,`amounts`,`category`) VALUES ('$title','$prize','$brandname','$images','$descriptions','$size','$amounts','$category')");
    if($sql)
    {
...
<form method="post" >
  ...
  <div class="col mt-4 fs-4 text-danger">
    <input type="int" class="form-control" placeholder="PRICE" name="prize">
  </div>
  <div class="col mt-4 fs-4 text-danger">
    <input type="text" class="form-control" placeholder="BRANDNAME" name="brandname">
  </div>
  <div class="col mt-4 fs-4 text-danger">
    ...
    <div class="row mt-3">
  <div class="col mt-4 fs-4 text-danger">
    <input type="text" class="form-control"  placeholder="IMAGE NAME" name="images">
</div>
  <div class="col mt-4 fs-4 text-danger">
    <input type="text" class="form-control" placeholder="AMOUNTS" name="amounts">
  </div>
  <div class="col mt-4 fs-4 text-danger">
  ...
  <div class="col mt-4 mb-4 fs-4 text-danger">
    <input type="text" class="form-control"  placeholder="DESCRIPTIONS" name="descriptions">
  </div>
  </div>
