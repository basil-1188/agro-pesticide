  ...
  <div class="container" >
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 d-none d-lg-block d-md-block-d-sm-block d-xs-none text-end mt-3">
        ...
        <div class="dropdown">
  <button class="btn btn-dark dropdown-toggle mb-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    MY Account
  </button>
...
<nav class="navbar" style="background-image: linear-gradient(#F3CEF4, #639369);">
  <div class="container">
    <a class="navbar-brand">    <h6 class="fw-bold mt-1 text-center text-dark">CATEGORY</h6>
                 <form  action="index1.php" method="POST" class="text-dark">
    ...
    <form action="index1.php" method="POST" class="form-group">
